...
const RegisterFieldsCurva NUMERO_SUBSISTEMA_1 = RegisterFieldsCurva("I3", NUMERO_SUBSISTEMA_1_SEQ);

const int PENALIDADE_1_SEQ[] = {12, 18};
const RegisterFieldsCurva PENALIDADE_1 = RegisterFieldsCurva("F7.2", PENALIDADE_1_SEQ);
...
const RegisterFieldsCurva NUMERO_SUBSISTEMA_2 = RegisterFieldsCurva("I3", NUMERO_SUBSISTEMA_2_SEQ);

// Registro tipo 2
const int ANO_2_SEQ[] = {1, 4};
const RegisterFieldsCurva ANO_2 = RegisterFieldsCurva("I4", ANO_2_SEQ);

const int PERCENTUAL_JAN_2_SEQ[] = {7, 11};
const RegisterFieldsCurva PERCENTUAL_JAN_2 = RegisterFieldsCurva("F5.1", PERCENTUAL_JAN_2_SEQ);

const int PERCENTUAL_FEV_2_SEQ[] = {13, 17};
const RegisterFieldsCurva PERCENTUAL_FEV_2 = RegisterFieldsCurva("F5.1", PERCENTUAL_FEV_2_SEQ);

const int PERCENTUAL_MAR_2_SEQ[] = {19, 23};
const RegisterFieldsCurva PERCENTUAL_MAR_2 = RegisterFieldsCurva("F5.1", PERCENTUAL_MAR_2_SEQ);

const int PERCENTUAL_ABR_2_SEQ[] = {25, 29};
const RegisterFieldsCurva PERCENTUAL_ABR_2 = RegisterFieldsCurva("F5.1", PERCENTUAL_ABR_2_SEQ);

const int PERCENTUAL_MAI_2_SEQ[] = {31, 35};
const RegisterFieldsCurva PERCENTUAL_MAI_2 = RegisterFieldsCurva("F5.1", PERCENTUAL_MAI_2_SEQ);

const int PERCENTUAL_JUN_2_SEQ[] = {37, 41};
const RegisterFieldsCurva PERCENTUAL_JUN_2 = RegisterFieldsCurva("F5.1", PERCENTUAL_JUN_2_SEQ);

const int PERCENTUAL_JUL_2_SEQ[] = {43, 47};
const RegisterFieldsCurva PERCENTUAL_JUL_2 = RegisterFieldsCurva("F5.1", PERCENTUAL_JUL_2_SEQ);

const int PERCENTUAL_AGO_2_SEQ[] = {49, 53};
const RegisterFieldsCurva PERCENTUAL_AGO_2 = RegisterFieldsCurva("F5.1", PERCENTUAL_AGO_2_SEQ);

const int PERCENTUAL_SET_2_SEQ[] = {55, 59};
const RegisterFieldsCurva PERCENTUAL_SET_2 = RegisterFieldsCurva("F5.1", PERCENTUAL_SET_2_SEQ);

const int PERCENTUAL_OUT_2_SEQ[] = {61, 65};
const RegisterFieldsCurva PERCENTUAL_OUT_2 = RegisterFieldsCurva("F5.1", PERCENTUAL_OUT_2_SEQ);

const int PERCENTUAL_NOV_2_SEQ[] = {67, 71};
const RegisterFieldsCurva PERCENTUAL_NOV_2 = RegisterFieldsCurva("F5.1", PERCENTUAL_NOV_2_SEQ);

const int PERCENTUAL_DEZ_2_SEQ[] = {73, 77};
const RegisterFieldsCurva PERCENTUAL_DEZ_2 = RegisterFieldsCurva("F5.1", PERCENTUAL_DEZ_2_SEQ);
...
const RegisterFieldsCurva MAX_ITERACOES_3 = RegisterFieldsCurva("I3", MAX_ITERACOES_3_SEQ);

// Registro tipo 2
const int ITERACAO_PENALIDADE_3_SEQ[] = {32, 34};
const RegisterFieldsCurva ITERACAO_PENALIDADE_3 = RegisterFieldsCurva("I3", ITERACAO_PENALIDADE_3_SEQ);

// Registro tipo 3
const int TOLERANCIA_3_SEQ[] = {30, 34};
const RegisterFieldsCurva TOLERANCIA_3 = RegisterFieldsCurva("F5.0", TOLERANCIA_3_SEQ);

// Registro tipo 4
const int RELATORIO_3_SEQ[] = {34, 34};
const RegisterFieldsCurva RELATORIO_3 = RegisterFieldsCurva("I1", RELATORIO_3_SEQ);
// ---------------------------------------------------
...
DataFieldCurva getData(std::string text, RegisterFieldsCurva field) {
    DataFieldCurva data;
